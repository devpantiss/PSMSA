    ...
    <section className="w-full bg-black grid grid-cols-1 md:grid-cols-3">
      {cards.map((card, idx) => (
        ...
        >
          ...
          {/* Purple accent hover overlay */}
          <div className="absolute inset-0 bg-purple-600/20 opacity-0 transition-all duration-300 group-hover:opacity-100" />
          ...
          <div className="relative z-10">
            ...
            {/* Accent line */}
            <div className="mt-5 h-[2px] w-10 rounded-full bg-purple-500" />
          </div>
        </div>
      ))}
    </section>
