      ...
      <div className="relative max-w-7xl mx-auto px-4 z-10">
        ...
        <div className="text-left mb-10">
          <h2 className="text-4xl md:text-5xl font-bold tracking-tight mb-3">
            <span className="border-l-4 border-purple-600 pl-3">
              ...
              <div className="bg-gray-900/80 backdrop-blur-md border border-gray-700 overflow-hidden shadow-md hover:shadow-[0_0_25px_rgba(220,38,38,0.5)] transition-all duration-300 flex flex-col h-[520px]">
                <div className="relative flex-shrink-0">
                  <img
                    src={cert.imageUrl}
                    alt={cert.title}
                    className="w-full h-[380px] object-cover ring-2 ring-purple-600"
                  />
                ...
                <div className="flex-grow flex flex-col justify-between p-6">
                  ...
                  <div className="h-1 w-20 mt-4 bg-gradient-to-r from-purple-600 to-green-600 rounded-full"></div>
                </div>
              </div>
            </div>
          ))}
