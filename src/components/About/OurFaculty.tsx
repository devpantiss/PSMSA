...
const OurFaculty: React.FC<OurFacultyProps> = ({
  ...
  return (
    <div className="relative w-full py-12 bg-black overflow-hidden">
      ...
      ></div>
      <div
        className="absolute bottom-[-20%] right-[-10%] bg-purple-600 w-[450px] h-[450px] rounded-full opacity-35 pointer-events-none"
        style={{
          filter: "blur(140px)",
        }}
      ></div>
      <div
        className="absolute top-[25%] left-[20%] bg-gradient-to-tr from-purple-600 to-green-500 w-[250px] h-[250px] rounded-full opacity-30 pointer-events-none"
        style={{
          filter: "blur(100px)",
        }}
      ></div>
