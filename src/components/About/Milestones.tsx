...
const milestonesData: Milestone[] = [
  {
    ...
    title: (
      <>
        <span className="text-purple-500">Rehabilitation</span> &{" "}
        <span className="text-purple-500">Resettlement</span>
      </>
    ),
    description:
  ...
  },
  {
    ...
    title: (
      <>
        <span className="text-purple-500">RPL</span> &{" "}
        <span className="text-purple-500">Mining Skill</span> Development
      </>
    ),
    description:
  ...
  },
  {
    ...
    title: (
      <>
        <span className="text-purple-500">Fisheries</span> Clusters in{" "}
        <span className="text-purple-500">Mining Pits</span>
      </>
    ),
    description:
  ...
  },
  {
    ...
    title: (
      <>
        <span className="text-purple-500">Guava Plantation</span> on{" "}
        <span className="text-purple-500">Abandoned Mining Land</span>
      </>
    ),
    description:
...
/* =======================
   Real Slick Arrows (WORKING)
======================= */

const ArrowBase =
  "slick-arrow absolute bottom-[-70px] z-20 flex h-11 w-11 items-center justify-center rounded-full border border-purple-500/30 bg-black/70 text-purple-400 backdrop-blur transition hover:bg-purple-500 hover:text-black";
...
const Milestones: React.FC = () => {
  const settings: Settings = {
    ...
    customPaging: (i: number) => (
      <button className="text-xs font-semibold text-purple-400 transition hover:text-purple-300">
  ...
  return (
    <section className="relative overflow-hidden py-20">
      ...
      <div className="pointer-events-none absolute inset-0">
        ...
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_30%_20%,rgba(168,85,247,0.22),transparent_55%)]" />
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_70%_80%,rgba(147,51,234,0.18),transparent_60%)]" />
            ...
            <div key={milestone.year} className="px-3">
              <div className="grid items-center gap-10 rounded-3xl border border-white/10 bg-white/5 p-6 backdrop-blur-xl lg:grid-cols-12 lg:p-10">
                ...
                <div className="relative overflow-hidden rounded-2xl lg:col-span-7">
                  ...
                  {/* Year Badge */}
                  <div className="absolute left-5 top-5 rounded-full bg-purple-500 px-4 py-1 text-sm font-semibold text-black shadow-lg">
                    {milestone.year}
                  </div>
                </div>
                ...
                <div className="lg:col-span-5">
                  ...
                  <div className="mt-6 h-[2px] w-12 rounded-full bg-purple-500" />
                </div>
              </div>
            </div>
          ))}
