...
const governmentPartners: string[] = [
    "/financialPartners/BOI.png",
    "/financialPartners/DMF.png",
    "/financialPartners/HDFC.png",
    "/financialPartners/NSDC.png",
    "/financialPartners/RBL.png",
    "/financialPartners/SBI.png",
];
...
const FinancePartners: React.FC = () => {
  return (
    <div className="bg-black relative overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-b from-black via-purple-900 to-black z-1"></div>
      <div className="flex flex-col justify-center items-center container mx-auto py-6 px-4 sm:px-12 relative z-10">
        <div className="flex justify-center mb-2">
        <h1 className="text-white text-4xl font-bold">
            OUR <span className="text-orange-600">FINANCIAL PARTNERS</span>
          </h1>
        </div>
...
export default memo(FinancePartners);