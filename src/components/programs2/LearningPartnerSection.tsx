...
export default function LearningPartnerSection() {
  ...
  return (
    <section className="relative w-full overflow-hidden bg-[#0B0B0E] text-white">
      {/* Background (Purple glow) */}
      <div className="absolute inset-0">
        <div className="absolute inset-0 bg-[#0B0B0E]" />

        <div className="absolute inset-0 bg-[radial-gradient(circle_at_78%_18%,rgba(147,51,234,0.55),transparent_55%)]" />
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_85%,rgba(168,85,247,0.18),transparent_60%)]" />
              ...
              <div key={row.id} className="relative">
                ...
                >
                  <div className="relative">
                    ...
                    >
                      <div className="h-full w-full bg-gradient-to-r from-purple-500/20 via-purple-500/10 to-transparent" />
                    </div>
