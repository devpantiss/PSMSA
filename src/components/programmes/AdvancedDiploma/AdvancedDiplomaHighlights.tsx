...
import { FaLightbulb, FaIndustry, FaRocket, FaUserGraduate } from "react-icons/fa";
...
interface AdvancedDiplomaHighlightsProps {}
...
const highlights: Highlight[] = [
  {
    ...
    description:
      "Structured training modules designed to upgrade existing skills and equip workers with the latest industry practices.",
    icon: <FaLightbulb className="w-6 h-6 text-green-400" />,
  },
  {
    title: "Industry-Aligned Curriculum",
    description:
      "Programs built in collaboration with industry experts, ensuring alignment with real-world job requirements and future trends.",
    icon: <FaIndustry className="w-6 h-6 text-green-400" />,
  },
  {
    title: "Career Growth Opportunities",
    description:
      "Facilitates career progression by enabling workers to move into higher-skilled roles, enhancing employability and income potential.",
    icon: <FaRocket className="w-6 h-6 text-green-400" />,
  },
  {
    title: "Inclusive Learning Process",
    description:
      "Accessible learning pathways for diverse backgrounds, empowering blue-collar workers to upskill and reskill effectively.",
...
const AdvancedDiplomaHighlights: React.FC<AdvancedDiplomaHighlightsProps> = () => {
  return (
    <section
...
export default memo(AdvancedDiplomaHighlights);
