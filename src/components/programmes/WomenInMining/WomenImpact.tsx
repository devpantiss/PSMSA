...
const metrics = [
  {
    label: "Women Operators Trained",
    value: 1850,
    suffix: "+",
    icon: CheckCircle,
  },
  {
    label: "Simulator + Practical Training Hours Delivered",
    value: 32000,
    suffix: "+",
    icon: Wrench,
  },
  ...
  {
    label: "Placement / Deployment Rate",
    value: 74,
    suffix: "%",
    icon: Building2,
  },
  {
    label: "Mining Industry Partners",
    value: 40,
    suffix: "+",
    icon: Users,
  },
  {
    label: "Operator Certification Success Rate",
    value: 88,
    suffix: "%",
    icon: Briefcase,
  },
...
const useCountUp = (end: number, enabled: boolean) => {
  ...
  useEffect(() => {
    ...
    const animate = (now: number) => {
      ...
      setCount(Number((progress * end).toFixed(0))); // cleaner for large values
...
export default function WomenImpact() {
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="max-w-3xl mb-16">
          <h2 className="text-4xl lg:text-5xl font-semibold tracking-tight">
            Women in Mining — Training Impact
          </h2>
          <p className="mt-4 text-gray-300 leading-relaxed">
            Real outcomes from our HEMM Vehicle Operator training pipeline —
            combining simulator-based practice, safety-first operations, and
            industry-aligned deployment pathways.
          </p>
        </div>
