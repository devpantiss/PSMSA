  ...
  return (
    <section className="relative h-[100vh] w-full flex items-center justify-center overflow-hidden bg-black">
      ...
      <div
        ...
        style={{
          backgroundImage: "url('/program/operator/operator_hero.jpg')",
      ...
      >
        <h1 className="text-4xl md:text-6xl font-extrabold mb-6 drop-shadow-lg tracking-tight font-sans">
          Operator Licencing & Certification Training
        </h1>

        <p className="text-lg md:text-xl text-gray-100 drop-shadow-md leading-relaxed">
          A structured, industry-aligned training programme designed to prepare
          candidates for{" "}
          <span className="text-green-400 font-semibold">
            certified HEMM operator licencing
          </span>{" "}
          in the mining sector. Learn through simulator-based practice, safety
          SOPs, real equipment exposure, and competency-based assessments —
          enabling job roles like{" "}
