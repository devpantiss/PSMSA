...
const sectors: Sector[] = [
  {
    name: "Mines",
    description:
      "Work-integrated modules for HEMM operations, mine safety, drilling support and site supervision — designed to make workers job-ready on mine sites.",
    icon: "⛏️",
    impact: { courses: 10, trained: 2200, placed: 1700 },
    certificationLevel: "Level 4-6",
    skills: ["HEMM Ops", "Mine Safety", "Site Supervision"],
  },
  {
    ...
    certificationLevel: "Level 4-6",
    skills: ["Furnace Ops", "Rolling Mill", "Metallurgy QC"],
  },
  {
    name: "Power & Green Energy",
    description:
      "Plant rotations, renewable energy installation & maintenance, and energy-efficiency practicum to upskill workforce for modern power assets.",
    icon: "⚡",
    impact: { courses: 16, trained: 3500, placed: 2800 },
    certificationLevel: "Level 5-7",
    skills: ["Plant Ops", "Solar & Wind", "Energy Audits"],
  },
  {
    name: "Shipping & Logistics",
    description:
      "Hands-on workplace attachments in port operations, cargo handling, warehouse management and logistics technology for fast-moving supply chains.",
    icon: "🚢",
    impact: { courses: 12, trained: 2600, placed: 2000 },
    certificationLevel: "Level 3-5",
    skills: ["Port Ops", "Warehouse Mgmt", "Freight Handling"],
  },
  {
    name: "Electric Vehicles",
    description:
      "Workplace-led training on EV powertrains, battery systems, diagnostics and charging infrastructure targeted at technicians and service staff.",
    icon: "🔋",
    impact: { courses: 9, trained: 1500, placed: 1100 },
    certificationLevel: "Level 5-7",
    skills: ["EV Systems", "Battery Tech", "Diagnostics"],
  },
  {
    name: "Construction Tech & Infra Equipment",
    description:
      "Site-driven skilling on heavy equipment operation, surveying, civil works and preventive maintenance for infrastructure projects.",
    icon: "🏗️",
    impact: { courses: 18, trained: 4200, placed: 3300 },
    certificationLevel: "Level 4-6",
    skills: ["Equipment Ops", "Surveying", "Civil Works"],
  },
  {
    name: "Water, Sanitation & Facility Management",
    description:
      "Practical placements in water systems, sanitation services, plumbing, and facility operations to support urban & rural infrastructure needs.",
    icon: "🚰",
    impact: { courses: 11, trained: 2100, placed: 1600 },
    certificationLevel: "Level 3-5",
    skills: ["Plumbing", "Sanitation Services", "Facility Ops"],
  },
];
    ...
    <section className="relative min-h-screen py-8 sm:py-12 lg:py-20 bg-black overflow-hidden">
      ...
      >
        ...
        >
          ...
          <div className="w-20 sm:w-28 h-1 bg-gradient-to-r from-purple-600 to-green-500 rounded-full mx-auto mb-4 sm:mb-6" />
          <p className="text-base sm:text-lg lg:text-xl text-white/80 max-w-3xl mx-auto leading-relaxed px-4">
            Earn-while-you-learn industry attachments and on-site modules for blue-collar roles — combining supervised workplace experience with targeted classroom coaching to deliver job-ready talent.
          </p>
        </motion.div>
            ...
            <div className="relative bg-white/5 backdrop-blur-xl rounded-2xl sm:rounded-3xl p-4 sm:p-6 border border-white/10 hover:border-green-500/50 transition-all duration-500 hover:shadow-2xl hover:shadow-green-500/20 group flex-1 flex flex-col">
              ...
              <div className="mb-4">
                ...
                <p className="text-white/70 text-sm sm:text-base">
                  See how WILP places learners on real worksites with mentor-led learning.
                </p>
              </div>
              ...
              <div className="mt-4 pt-4 border-t border-white/10">
                <div className="flex flex-wrap items-center justify-between gap-2 text-xs sm:text-sm text-white/60">
                  <span>📺 Watch our WILP introduction</span>
            ...
            <div className="flex-1 flex flex-col">
              ...
              <div className="mb-4 sm:mb-6">
                <h3 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold text-white mb-3 sm:mb-4">
                  Work-Integrated Skills Across{" "}
                  <span className="bg-green-500 bg-clip-text text-transparent">
                    7 Key Sectors
                  </span>
                </h3>
                <p className="text-white/70 text-sm sm:text-base lg:text-lg leading-relaxed">
                  WILP embeds learners in workplace environments across core blue-collar sectors — delivering practical experience, safety training and employer-validated competencies.
                </p>
              </div>
          ...
          >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4 lg:gap-6">
              ...
              >
                ...
                <div className="text-xs text-white/50 mt-1">Successfully</div>
              </motion.div>
            </div>

            {/* Success Rate Indicator */}
            <div className="mt-4 sm:mt-6 text-center">
              <div className="inline-flex items-center px-3 py-1 bg-gradient-to-r from-green-500/20 to-purple-600/20 rounded-full border border-white/10">
                <div className="w-2 h-2 bg-green-500 rounded-full mr-2 animate-pulse"></div>
                <span className="text-xs sm:text-sm text-white/80 font-medium">
                  {Math.round((currentImpact.placed / currentImpact.trained) * 100)}% Success Rate
                </span>
              </div>
            </div>
          </motion.div>
...
export default memo(WILPOverview);
