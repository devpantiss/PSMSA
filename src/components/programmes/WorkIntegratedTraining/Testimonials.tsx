...
const testimonials: Testimonial[] = [
  ...
  {
    text: `LabourNet’s training helped me secure a job in just 3 months. The hands-on sessions were amazing!`,
    name: "Priya Sharma",
    designation: "Student - Batch 2024",
    photo: "https://via.placeholder.com/150",
    category: "Students",
  },
  {
    text: `The practical skills I gained here transformed my career prospects. Highly recommended!`,
    name: "Rahul Verma",
    designation: "Student - Batch 2024",
    photo: "https://via.placeholder.com/150",
    category: "Students",
  },
  // Trainers Testimonials (Placeholder)
  {
    text: `Training with LabourNet is rewarding. The support and resources are top-notch.`,
    name: "Anita Desai",
  ...
  {
    text: `I love the interactive approach LabourNet provides for skill development.`,
    name: "Vikram Singh",
      ...
      <div className="max-w-8xl mx-auto px-6 relative z-20 flex flex-col md:flex-row">
        ...
        <div className="w-full md:w-3/4">
          <h2 className="text-5xl font-semibold text-white text-center mb-12 relative tracking-wide">
            Trusted by the <span className="text-purple-600">Best</span>
...
export default TestimonialSectionWILP;
