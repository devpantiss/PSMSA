...
const highlights: Highlight[] = [
  {
    ...
    description:
      "Formal recognition of existing skills through comprehensive assessments, ensuring your experience is valued.",
    icon: <FaUserCheck className="w-6 h-6 text-green-400" />,
  },
  {
    title: "Industry Recognition",
    description:
      "Gain certifications respected across industries, enhancing your professional credibility.",
    icon: <FaTrophy className="w-6 h-6 text-green-400" />,
  },
  {
    title: "Career Advancement",
    description:
      "Unlock new job opportunities and promotions without redundant training, saving time and resources.",
    icon: <FaBriefcase className="w-6 h-6 text-green-400" />,
  },
  {
    title: "Efficient Process",
    description:
      "Streamlined evaluation process tailored to your experience, designed for quick certification.",
...
const WILPHighlights: React.FC<WILPHighlightsProps> = () => {
  return (
    <section
      className="relative py-24 bg-black overflow-hidden"
      role="region"
      aria-label="RPL Key Highlights"
    >
...
export default memo(WILPHighlights);