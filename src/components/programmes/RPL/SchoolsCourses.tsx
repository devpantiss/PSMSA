...
const schools: School[] = [
  {
    ...
    description: "Leading industrial skills training in mining, steel production, and aluminium processing",
  ...
  },
  {
    ...
    description: "Renewable energy and power generation skills for the sustainable future",
  ...
  },
  {
    ...
    description: "Global trade and supply chain management expertise",
  ...
  },
  {
    ...
    description: "Building tomorrow's infrastructure with skilled professionals",
  ...
  },
  {
    ...
    shortName: "Tech & EV",
    description: "Cutting-edge technology training for the digital automotive age",
  ...
  },
  {
    ...
    description: "Sustainable careers for environmental conservation and clean energy",
...
const RplSchoolsCarousel: React.FC = () => {
  ...
  return (
    <section 
      ...
      role="region"
      aria-label="RPL Schools Carousel"
    >
      {/* Background Video */}
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-6xl font-bold text-white mb-6 bg-gradient-to-r from-white via-green-100 to-purple-100 bg-clip-text text-transparent">
            RPL Schools & Programs
          </h2>
          <p className="text-lg text-gray-300 max-w-2xl mx-auto leading-relaxed">
            Discover industry-leading skill development programs aligned with NSQF standards
          </p>
...
export default memo(RplSchoolsCarousel);