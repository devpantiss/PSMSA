...
const sectors: Sector[] = [
  {
    ...
    description:
      "Certifies expertise in mining operations, steel fabrication, and aluminium processing for enhanced safety and productivity in heavy industry operations.",
    icon: "⚒️",
  ...
  },
  {
    name: "Power & Energy",
    description:
      "Validates skills in power plant operations, renewable energy systems, and energy efficiency management for sustainable future.",
    icon: "⚡",
  ...
  },
  {
    ...
    description:
      "Recognizes proficiency in warehouse management, freight forwarding, and port operations for global trade excellence.",
    icon: "🚢",
  ...
  },
  {
    ...
    description:
      "Certifies skills in construction supervision, plumbing, and facility maintenance for modern urban development.",
    icon: "🏗️",
  ...
  },
  {
    ...
    description:
      "Validates expertise in semiconductor fabrication and electric vehicle technology for the digital future.",
    icon: "🔬",
  ...
  },
  {
    name: "Green Jobs",
    description:
      "Recognizes skills in sustainable agriculture, solar installation, and waste management for environmental sustainability.",
    icon: "🌱",
  ...
  },
  {
    ...
    description:
      "Certifies proficiency in textile manufacturing and garment production for fashion and textile industries.",
    icon: "🧵",
  ...
  },
  {
    ...
    description:
      "Validates skills in community mobilization and social health work for inclusive societal growth.",
    icon: "🤝",
      ...
      >
        ...
        >
          ...
          <p className="text-base sm:text-lg lg:text-xl text-white/80 max-w-3xl mx-auto leading-relaxed px-4">
            Empowering professionals through skill recognition and certification
            ...
            <div className="relative bg-white/5 backdrop-blur-xl rounded-2xl sm:rounded-3xl p-4 sm:p-6 border border-white/10 hover:border-green-500/50 transition-all duration-500 hover:shadow-2xl hover:shadow-green-500/20 group flex-1 flex flex-col">
              ...
              <div className="mb-4">
                ...
                <p className="text-white/70 text-sm sm:text-base">
                  Discover how RPL transforms careers across industries
                </p>
              </div>
            ...
            <div className="flex-1 flex flex-col">
              ...
              <div className="mb-4 sm:mb-6">
                ...
                <p className="text-white/70 text-sm sm:text-base lg:text-lg leading-relaxed">
                  The Recognition of Prior Learning (RPL) program validates and
                  certifies skills across diverse industries, aligning with NSQF
                  standards.
                </p>
              </div>
            ...
            <div className="mt-4 sm:mt-6 text-center">
              <div className="inline-flex items-center px-3 py-1 bg-gradient-to-r from-green-500/20 to-purple-600/20 rounded-full border border-white/10">
                ...
                <span className="text-xs sm:text-sm text-white/80 font-medium">
                  {Math.round(
                    (currentImpact.placed / currentImpact.trained) * 100
                  )}
                  % Success Rate
                </span>
              </div>
