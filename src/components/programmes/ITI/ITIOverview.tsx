...
const sectors: Sector[] = [
  {
    name: "Mines",
    description:
      "ITI trades for safe mining operations, HEMM handling, drilling support and mine-site safety practices — job-ready for site roles.",
    icon: "⛏️",
    impact: { courses: 10, trained: 2200, placed: 1700 },
    certificationLevel: "NSQF Levels 4-6",
    skills: ["Mining Ops", "Mine Safety", "Equipment Handling"],
  },
  {
    name: "Steel & Aluminium",
    description:
      "Hands-on ITI trades in welding, plate fabrication, furnace/shop-floor safety and basic metallurgical handling for rolling mills and foundries.",
    icon: "🏭",
    impact: { courses: 14, trained: 3000, placed: 2400 },
    certificationLevel: "NSQF Levels 4-6",
    skills: ["Welding", "Fabrication", "Mechanical Fitting"],
  },
  {
    name: "Power & Green Energy",
    description:
      "ITI trades focused on electrical installations, solar PV installation, basic power-plant assistance and energy-efficient practices.",
    icon: "⚡",
    impact: { courses: 16, trained: 3500, placed: 2800 },
    certificationLevel: "NSQF Levels 5-7",
    skills: ["Electrical Systems", "Solar PV", "Energy Management"],
  },
  {
    ...
    skills: ["Port Ops", "Inventory", "Cargo Handling"],
  },
  {
    name: "Electric Vehicles",
    description:
      "ITI trades in EV servicing, battery handling, charging systems and basic diagnostics tailored for evolving e-mobility workshops.",
    icon: "🔋",
    impact: { courses: 9, trained: 1500, placed: 1100 },
    certificationLevel: "NSQF Levels 5-7",
    skills: ["EV Servicing", "Battery Tech", "Diagnostics"],
  },
  {
    name: "Construction Tech & Infra Equipment",
    description:
      "Practical ITI trades for construction equipment operation, concrete works, formwork and equipment maintenance for site readiness.",
    icon: "🏗️",
    impact: { courses: 18, trained: 4200, placed: 3300 },
    certificationLevel: "NSQF Levels 4-6",
    skills: ["Equipment Ops", "Concrete Tech", "Surveying"],
  },
  {
    name: "Water, Sanitation & Facility Management",
    description:
      "Trades in pump operation, water treatment basics, sanitation maintenance and facility services for institutional and community settings.",
    icon: "🚰",
    impact: { courses: 11, trained: 2100, placed: 1600 },
    certificationLevel: "NSQF Levels 3-5",
    skills: ["Pump Ops", "Sanitation", "Facility Maintenance"],
  },
];
  ...
  return (
    <section className="relative min-h-screen py-8 sm:py-12 lg:py-20 bg-black overflow-hidden">
      ...
      >
            ...
            <div className="relative bg-white/5 backdrop-blur-xl rounded-2xl sm:rounded-3xl p-4 sm:p-6 border border-white/10 hover:border-green-500/50 transition-all duration-500 hover:shadow-2xl hover:shadow-green-500/20 group flex-1 flex flex-col">
              <div className="mb-4">
                <h3 className="text-lg sm:text-xl lg:text-2xl font-bold text-white mb-2">
                  ITI <span className="bg-green-500 bg-clip-text text-transparent">Introduction</span>
                </h3>
                <p className="text-white/70 text-sm sm:text-base">
                  Learn how ITI trades prepare learners for shop-floor roles, apprenticeships and entry-level technical positions.
                </p>
              </div>
        ...
        {/* Dynamic Impact Data (ITI-specific labels) */}
        {currentImpact && (
          <motion.div
          ...
          >
            <div className="mb-4 sm:mb-6 text-center">
              ...
              <p className="text-white/60 text-xs sm:text-sm lg:text-base">Current sector performance metrics (ITI)</p>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4 lg:gap-6">
              ...
              >
                ...
                <div className="text-xs sm:text-sm lg:text-base text-white/70 font-medium">ITI Trades</div>
              ...
              >
                ...
                <div className="text-xs sm:text-sm lg:text-base text-white/70 font-medium">Students Trained</div>
        ...
        <div className="mt-8 sm:mt-12 lg:mt-16 grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4 sm:gap-6 lg:gap-8">
          <motion.div variants={itemVariants as Variants} className="bg-white/5 backdrop-blur-xl rounded-xl p-4 sm:p-6 border border-white/10 hover:border-green-500/50 transition-all duration-300">
            <h4 className="text-lg sm:text-xl font-bold text-white mb-2">Hands-on Workshops</h4>
            <p className="text-white/70 text-sm sm:text-base">Practical bench- and shop-based sessions that build core technical competence.</p>
          </motion.div>

          <motion.div variants={itemVariants as Variants} className="bg-white/5 backdrop-blur-xl rounded-xl p-4 sm:p-6 border border-white/10 hover:border-green-500/50 transition-all duration-300">
            <h4 className="text-lg sm:text-xl font-bold text-white mb-2">NSQF-aligned Certificates</h4>
            <p className="text-white/70 text-sm sm:text-base">Recognized ITI/NSQF certifications and pathways to apprenticeships and higher technical roles.</p>
          </motion.div>

          <motion.div variants={itemVariants as Variants} className="bg-white/5 backdrop-blur-xl rounded-xl p-4 sm:p-6 border border-white/10 hover:border-green-500/50 transition-all duration-300">
            <h4 className="text-lg sm:text-xl font-bold text-white mb-2">Industry Linkages</h4>
            <p className="text-white/70 text-sm sm:text-base">Partnerships with local employers for internships, on-the-job training and placements.</p>
          </motion.div>

          <motion.div variants={itemVariants as Variants} className="bg-white/5 backdrop-blur-xl rounded-xl p-4 sm:p-6 border border-white/10 hover:border-green-500/50 transition-all duration-300">
            <h4 className="text-lg sm:text-xl font-bold text-white mb-2">Career Pathways</h4>
            <p className="text-white/70 text-sm sm:text-base">Clear routes from ITI trade certificates to apprenticeships and further upskilling opportunities.</p>
          </motion.div>
        </div>
      </motion.div>
    </section>
...
export default memo(ITIOverview);
