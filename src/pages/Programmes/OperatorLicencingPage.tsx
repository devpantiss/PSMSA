...
import OperatorHero from "../../components/programmes/operator/OperatorHero";
import OperatorImpact from "../../components/programmes/operator/OperatorImpact";
import ProgramOverviewVideo from "../../components/common/ProgramOverviewVideo";
import OperatorSchoolsCourses from "../../components/programmes/operator/OperatorSchoolsCourses";
...
import OperatorTestimonial from "../../components/programmes/operator/OperatorTestimonial";
import OperatorBenefitCards from "../../components/programmes/operator/OperatorBenefitCards";

const OperatorLicencingPage: React.FC = () => {
  const schoolLogos = [
    {
  ...
  return (
    <div>
      ...
      <OperatorSchoolsCourses />
      <OperatorBenefitCards />
...
export default OperatorLicencingPage;
